...
export function AppearancePanel() {
  ...
  return (
    <section className="max-w-3xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Aparência"
        description="Defina o modo e a cor de destaque usados em todo o aplicativo. Salvo neste dispositivo — experimente, a mudança é ao vivo."
      />
...
function ModeCard({
  ...
  return (
    <button
      ...
      aria-label={`Usar modo ${modeLabel}`}
      className={cn(
