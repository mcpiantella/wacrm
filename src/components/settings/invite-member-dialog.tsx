...
const ROLE_DESCRIPTIONS: Record<InviteRole, string> = {
  ...
  agent:
    'Pode usar a caixa de entrada, contatos, disparos, automações e fluxos. Sem acesso a configurações ou membros.',
    ...
    >
      <DialogContent className="bg-popover border-border sm:max-w-md">
        {result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Compartilhe este link com seu novo colega. Ele(a) poderá
                se cadastrar (ou entrar) e ingressar na conta como{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto original — ao fechar este diálogo o
                link se perde. Para reenviar, revogue este convite e crie um
                novo.
              </div>
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-popover-foreground">Convidar membro</DialogTitle>
              <DialogDescription className="text-muted-foreground">
                Gere um link de convite único. Compartilhe via WhatsApp,
                Slack ou qualquer canal — sem necessidade de serviço de e-mail.
              </DialogDescription>
            </DialogHeader>
