...
export function WhatsAppConfig() {
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          data.phone_info?.verified_name
            ...
            : 'WhatsApp conectado. Os eventos começarão a chegar em um minuto.',
        );
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        toast.success('Número totalmente configurado — o Meta está entregando eventos.');
      } else {
        toast.error(
          'Número não está totalmente registrado. Veja os diagnósticos abaixo para saber qual etapa falhou.',
          { duration: 8000 },
        );
      }
      if (accountId) await fetchConfig(accountId);
  ...
  async function handleReset() {
    ...
    try {
      ...
      toast.success('Configuração removida. Você pode inserir suas credenciais novamente.');
      setConfig(null);
      setPhoneNumberId('');
      setWabaId('');
      setAccessToken('');
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte sua API Meta WhatsApp Business. Credenciais, webhook e instruções de configuração estão aqui."
        />
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu token de acesso se autentica com o Meta. Consulte o status de Registro abaixo para verificar se os webhooks estão configurados.'
              : statusMessage ||
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Insira (ou corrija) o PIN de duas etapas abaixo e clique em
                  Salvar Configuração para tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes do rastreamento de registro
                  existir, ou o registro foi ignorado. Insira o PIN de duas
                  etapas abaixo e clique em Salvar Configuração para inscrevê-lo.
                </>
              )}
            </AlertDescription>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Insira suas credenciais da API Meta WhatsApp Business.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-muted-foreground">ID da Conta Business do WhatsApp</Label>
              <Input
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como callback de webhook no painel do aplicativo Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
          ...
          <CardContent>
            ...
            <div className="mt-4 pt-4 border-t border-border">
              ...
              >
                ...
                Documentação da API WhatsApp Meta
              </a>
            </div>
          </CardContent>
        </Card>
