      ...
      <SettingsPanelHead
        ...
        description={
          <>
            ...
            <code className="text-xs">/api/v1</code>) para que você possa criar
            suas próprias automações. Envie-as como{' '}
        ...
        {createdKey ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                local seguro — se perdê-la, revogue-a e crie uma nova.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Nomeie-a com base na integração que a usará e conceda apenas os
                escopos necessários.
              </DialogDescription>
            </DialogHeader>
