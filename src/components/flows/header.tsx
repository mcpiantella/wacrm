  ...
  return (
    <div className="flex flex-col gap-3">
        ...
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          {dirty && (
            <span
              ...
              title="Alterações não salvas — pressione Salvar para persistir"
              aria-live="polite"
            >
      ...
      <Input
        ...
        placeholder="Descrição opcional (interna — clientes não veem isso)"
...
function StatusBadge({ status }: { status: BuilderState["status"] }) {
  ...
  const label = { draft: "Rascunho", active: "Ativo", archived: "Arquivado" }[status];
  return (
