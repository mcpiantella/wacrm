...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  ...
  { value: "time_based", label: "Baseado em Horário", hint: "Em um agendamento recorrente" },
]
    ...
    <div className="space-y-2">
      <div>
        ...
        <Input
          ...
          placeholder="ex.: preço, solicitar demo, falar com vendas"
          className="bg-muted text-foreground"
        />
      </div>
      <div>
    ...
    case "create_deal":
      return (
        <>
          ...
          <FieldBlock label="ID do Estágio">
            <Input
    ...
    case "close_conversation":
      return (
        <p className="text-xs text-muted-foreground">
          Define o status da conversa como &quot;fechado&quot;. Nenhuma configuração necessária.
        </p>
      )
    default:
      return null
