    ...
    <div className="space-y-6">
      ...
      {mediaHeaderType && (
        <div className="rounded-xl border border-border bg-card/50 p-4">
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">
            URL pública do(a) {mediaHeaderType} enviado(a) como cabeçalho da mensagem.
            Usado para todos os destinatários deste disparo.
          </p>
          {mediaHeaderType === 'image' &&
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-foreground">Pré-visualização ao Vivo</p>
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          Mapeie todos os marcadores antes de continuar — ainda faltam{' '}
          <span className="font-mono font-semibold">
            {unmappedKeys.join(', ')}
          </span>
          . Caso contrário, esses marcadores serão enviados ao Meta como strings vazias.
        </div>
      )}
