...
//   on the list falls through to the canonical-app fallback with a
...
//
// The fallback is a last resort only — every deploy should set
// `NEXT_PUBLIC_SITE_URL` to its own hostname so invite links point at
// the right place.
...
function getBaseUrl(request: Request): string {
  ...
  return "https://zenithsender.crmzenith.com";
}
